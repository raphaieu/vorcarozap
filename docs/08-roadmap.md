...
- **Evolução Documental ([ADR-012](adr/ADR-012-navegacao-documental-e-referencias-a-acervos-externos.md)):**
  ...
  - VZ-023: Viewer SSR de documentos e sequências contextuais (avaliação técnica de viabilidade em Go/Templ, auditoria de integridade e conformidade de direitos/licenças).
