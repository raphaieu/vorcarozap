...
- **Próximo item:** Invalidação imediata de visualizações, métricas e exportação após moderação (VZ-017 — Fase 5).
- **Planejado:** Invalidação imediata de visualizações, métricas e exportação após moderação (VZ-017).
