...
- **Próximo item:** Acionamento manual e acompanhamento do monitor (VZ-017 — Fase 5) e Moderação granular de usos de evidência com quarentena automática ao perder último suporte ativo (VZ-021).
- **Planejado:** Moderação granular de `evidence_sources` (VZ-021), acionamento manual do monitor (VZ-017) e invalidação de cache/métricas.
